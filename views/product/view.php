...
<section class="product-section">
	<div class="container">
		<div class="back-link">
			<a href="<?= \yii\helpers\Url::to(['category/view', 'id' => $product->category->id]) ?>"> &lt;&lt; Вернуться в Категорию</a>
		</div>
		<div class="row">
			<div class="col-lg-6">
			...
			<div class="col-lg-6 product-details">
                            ...
                            <div class="p-review">
                                    <a href="">3 отзыва</a>|<a href="">Добавьте ваш отзыв</a>
                            </div>
                            ...
                            <a href="<?= yii\helpers\Url::to(['cart/add', 'id' => $product->id]) ?>" class="site-btn add-to-cart" data-id="<?= $product->id ?>">В КОРЗИНУ</a>
                    <div id="accordion" class="accordion-area">
                        ...
                        <div class="panel">
                            <div class="panel-header" id="headingTwo">
                                <button class="panel-link" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2">Подробнее </button>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-header" id="headingThree">
                                    <button class="panel-link" data-toggle="collapse" data-target="#collapse3" aria-expanded="false" aria-controls="collapse3">Доставка и Возврат Товара</button>
                            </div>
                            <div id="collapse3" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                <div class="panel-body">
                                    <h4>7 дней возврата</h4>
                                    <p>Наложенный платеж доступен<br>Доставка на дом <span>3 - 4 дня</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
